...
var fight = function(enemy) {
    while (playerInfo.health > 0 && enemy.health > 0) {
     if (fightOrSkip()) {
         // if true, leave fight by breaking lopp
         break;
     }
...
var startGame = function() {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            // pass the pickedEnemyObj variable's value into the fight function, where it will assume the value of the enemyObj parameter
